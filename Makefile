...
KERNEL_OBJ_PATH := $(TOP_DIR)/linux_5.10/build/kernel_output
SSV_DRV_PATH := $(PWD)/icommsemi/sv6x5x
...
obj-$(CONFIG_SV6x5x) += $(KMODULE_NAME).o
...
obj-$(CONFIG_SV6x5x) += $(KMODULE_PRE_ALLOCATE_NAME).o
else
